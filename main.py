...
bg2 = pygame.image.load("background/bg2.jpg")
intro = pygame.image.load("background/intro1.png")
outro = pygame.image.load("background/outro.png")
...
#Game Title
pygame.display.set_caption("Snake By Yash")
